...
typedef struct {
    ...
    void Texto_print(Texto* this){
        ...
        printf("Texto com tamanho de: (%s), fonte: (%d) e posição: (%d, %d)", this->tam_texto, this->fonte, sup->x, sup->y);
    }
    ...
    int main(){
        Figure* figs[4] = {
            (Figure*) rect_new(50,50,50,50,50);
            (Figure*) ellipse_new(50,5,90,100);
            (Figure*) texto_new(100,205,"alo, teste","ITALIC",30);
