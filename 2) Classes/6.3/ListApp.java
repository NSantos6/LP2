        ...
        this.addKeyListener (
            new KeyAdapter() {
                public void keyPressed (KeyEvent evt) {
                    ...
                    int x3 = rand.nextInt(70);
                    int y1 = rand.nextInt(70);
                    int y2 = rand.nextInt(70);
                    int y3 = rand.nextInt(70);
                    ...
                    if (evt.getKeyChar() == 'r') {
                        figs.add(new Rect(x, y, w, h, fundo));
                    } else if (evt.getKeyChar() == 'e') {
                        figs.add(new Ellipse(x, y, w, h, fundo));
