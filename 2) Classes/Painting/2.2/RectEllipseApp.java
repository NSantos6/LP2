...
class RectEllipseFrame extends JFrame {
    ...
    RectEllipseFrame () {
        ...
        this.e1 = new Ellipse(60, 100, 170, 20, Color.yellow, Color.cyan);
        this.e2 = new Ellipse(150, 116, 80, 90, Color.red, new Color(0, 255, 0));
        this.e3 = new Ellipse(50, 150, 60, 110, Color.orange, Color.magenta);
...
class Ellipse {
    ...
    Ellipse (int x, int y, int w, int h, Color lados, Color fundo) {
        this.x = x;
        this.y = y;
        this.w = w;
        this.h = h;
